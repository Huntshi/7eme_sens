...
<body>
    <header class="row col-12">
        ...
        <div class="row col-5 offset-md-1">
            <a href="../page_connexion/CreerCompte.html" class="col-4 offset-md-3 row btn-accueilins"><h5 style="margin-top: auto; margin-bottom: auto;">S'inscrire</h5></a>
            <a href="../page_connexion/connexionFront.php" class="col-4 offset-md-1 row btn-accueil"><h5 style="margin-top: auto; margin-bottom: auto;">Se connecter</h5></a>
        </div>
    </header>
    <main>
        <?php
