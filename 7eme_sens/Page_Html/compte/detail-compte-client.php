...
<header class="row col-12">
    ...
    <main>
            ...
            <div class="row offset-md-2">
                    ...
                    <div class="column">
                            <img src="Ellipse.svg">
                            <h1 class="text-center titre headconn">MON COMPTE</h1>
                        <div class="row">
                        ...
                        <div class="row">
                            <label for="email">Nombre de réservation réalisé</label>
                            <p>4</p>
                        </div> 
                        <button type="submit" class="btn-accueil">signaler</button> 
                    </div> 
